...
onMounted(async () => {
  ...
  try {
    ...
    state.loading = false;
    console.log(secondObject.value);
          ...
          <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
            ...
            <aside>
              ...
              <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <h2 class="text-2xl">{{ secondObject.name }}</h2>
                ...
                <p class="my-2 bg-green-100 p-2 font-bold">
                  {{ secondObject.contactEmail }}
                </p>

                <h3 class="text-xl">Contact Phone:</h3>

                <p class="my-2 bg-green-100 p-2 font-bold">{{ secondObject.contactPhone }}</p>
              </div>
